@format @format_ludimoodle @javascript @_file_upload @ludimoodle_score
Feature: Score game element section attribution in Ludimoodle course format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Ludimoodle Score | L1 | ludimoodle | 3 | 1 |
  ...
  Scenario: Verify score elements appear only in configured section
    ...
    And "img.ludimoodle-img[src*='chest.svg']" "css_element" should exist in the "div.rightdottedscore" "css_element"
    ...
    # Score Note Only
    And "img.ludimoodle-img[src*='bag.svg']" "css_element" should exist in the ".col-8 .row .cm-score:first-child" "css_element"
    ...
    And "img.ludimoodle-img[src*='bag.svg']" "css_element" should exist in the ".col-8 .row div:nth-child(2) .cm-score" "css_element"
    ...
    # Score Both
    And "img.ludimoodle-img[src*='bag.svg']" "css_element" should exist in the ".col-8 .row div:nth-child(3) .cm-score" "css_element"
    ...
    And "img.ludimoodle-img[src*='none.svg']" "css_element" should exist in the ".col-8 .row div:nth-child(2)" "css_element"
